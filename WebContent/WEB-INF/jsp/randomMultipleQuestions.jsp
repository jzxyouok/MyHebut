...
<body>
									...
									<c:forEach var="question" items="${questions}"
										...
										<li class="list-group-item" id="${status.index}_question" style="display: none">
											<p>${question.content}</p> 
												<label><input type="checkbox" name="${status.index}_answer" value="A">
												...
												<br><br>
												<label><input type="checkbox" name="${status.index}_answer" value="B">
													B.&nbsp;&nbsp;${question.answerB}</label>
													<i class="fa fa-times" aria-hidden="true" style="color:red;display: none"></i>
													<i class="fa fa-check" aria-hidden="true" style="color:green;display: none"></i>
												<br><br>
												<label><input type="checkbox" name="${status.index}_answer" value="C">
													C.&nbsp;&nbsp;${question.answerC}</label>
													<i class="fa fa-times" aria-hidden="true" style="color:red;display: none"></i>
													<i class="fa fa-check" aria-hidden="true" style="color:green;display: none"></i>
												<br><br>
												<label><input type="checkbox" name="${status.index}_answer" value="D">
	...
	<script src="${basePath}/js/system/random_multiple_questions.js"></script>
