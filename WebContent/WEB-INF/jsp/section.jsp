		...
		<div class="row">
			...
			<div class="main">
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li class="active"><i class="fa fa-files-o"></i>${section}</li>
						</ol>
					</div>
				...
				<div class="main_page">
								...
								<div class="row">
									<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
										...
										<c:if test="${not empty answerE}">	
											<label id="${status.index}_single_E"><input type="radio" name="${status.index}_single" value="E">
											E.&nbsp;&nbsp;${question.answerE}</label><br> 
										</c:if>
							...
							<ol class="list-group">
								...
								<div class="row">
									<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
										...
										<c:set var="answerE"  value="${question.answerE}"/>
										<c:if test="${not empty answerE}">	
											<label id="${status.index}_multiple_E"><input type="checkbox" name="${status.index}_multiple" value="E">
											E.&nbsp;&nbsp;${question.answerE}</label><br> 
										</c:if>
					...
					<input type="text" value="${singleQuestions.size()}" id="singleAmount" name="singleAmount" style="display: none">
					<input type="text" value="${multipleQuestions.size()}" id="multipleAmount" name="multipleAmount" style="display: none">
